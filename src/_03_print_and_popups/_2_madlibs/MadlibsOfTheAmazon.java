...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adj=JOptionPane.showInputDialog("enter a adjective that you think is appropriate");
		// Get the player to enter a type of liquid
		String lq=JOptionPane.showInputDialog("name a liquid to fit");
		// Get the player to enter a body part
		String bopa=JOptionPane.showInputDialog("and a body part as well");
		// Get the player to enter a verb
		String vb=JOptionPane.showInputDialog("how bout a verb as well cuz why not");
		// Get the player to enter a place
		String plc=JOptionPane.showInputDialog("name a place whaddyaSay");
		...
		"night. Piranhas are attracted to fresh "+lq+" and will most\n"  +
		"likely take a bite out of your "+bopa+" if you "+vb+". Whatever\n"  +
